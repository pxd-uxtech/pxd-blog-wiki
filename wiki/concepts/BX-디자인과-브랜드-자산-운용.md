...
브랜드 자산 운용에서 핵심은 인지 전략이다. 토스는 도전이라는 단 하나의 핵심 가치를 정립하는 데 7개월을 투자했으며, 심플리시티(Simplicity)를 브랜드의 큰 기조로 삼고 내부 구성원이 모두 같은 하나의 단어를 떠올릴 수 있도록 학습시켰다. 브랜드 기조가 내부에서 공유될 때 일관된 판단 기준이 생기고, 의사결정 속도와 업무 효율이 높아진다.
