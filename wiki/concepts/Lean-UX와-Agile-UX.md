...
sources: ["/878", "/832", "/764", "/757", "/803", "/761", "/360", "/980"]
updated: "2026-08-03"
---
# Lean UX와 Agile UX
...
2014년 12월, pxd는 자체 주최 컨퍼런스로는 처음으로 **Lean UX Conference**를 열었다. 발표는 이지현(서울여대) 교수의 Lean UX 배경과 국내 스타트업 적용 사례 연구, 김수영(당시 exelab)의 국내 기업 실험 사례, 김희선의 실리콘밸리 B2B 스타트업 Lean UX 경험, 김수의 린 프로토타이핑, 그리고 이재용 사회로 진행된 좌담회 순으로 구성됐다.
...
- **2014년 pxd 첫 Lean UX 컨퍼런스**: 이지현(배경·국내 스타트업 사례연구)·김수영(국내 실험사례)·김희선(실리콘밸리 B2B 사례)·김수(린 프로토타이핑) 발표와 좌담회로 구성
