...
- [[Next.js API 프록시 레이어]] — 같은 App Router 생태계의 다른 아키텍처 패턴(API Routes를 BFF 프록시로 활용)
- [[React 서버 중심 렌더링 생태계 동향]] — App Router가 속한 Server Components·Streaming UI·React Compiler 등 React 생태계 전반의 흐름
